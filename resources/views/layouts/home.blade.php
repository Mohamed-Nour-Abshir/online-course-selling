...
<head>
    ...
    <!--<link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/images/Logo-04.png')}}" style="border-radius: 50%;">-->
            ...
            <div class="topbar-menu-area">
                <div class="container">
                    <div class="topbar-menu left-menu">
                        <ul>
                            <li class="menu-item" >
                                <a title="Hotline: (+880) 1934-453-979" href="#"><span class="icon label-before fa fa-mobile"></span>Hotline: (+880) 1934-453-979</a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="container">
                <div class="mid-section main-info-area">
                    ...
                    <div class="wrap-logo-top left-section">
                        ...
                        {{-- <a href="/" class="link-to-home"><img src="asset('assets/images/logo.png')" alt=""></a> --}}
                    </div>
                ...
                <div class="primary-nav-section">
                    <div class="container">
                        <ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
                            <li class="menu-item {{ request()->is('*/*') ? 'home-icon active' : '' }}">
                                <a href="{{url('/')}}" class="link-term mercado-item-title"><i class="fa fa-home" aria-hidden="true"></i></a>
                            </li>
                            <li class="menu-item {{ request()->is('*about*') ? ' home-icon active' : '' }}">
                                <a href="{{url('/about')}}" class="link-term mercado-item-title">About Us</a>
                            </li>
                            <li class="menu-item {{ request()->is('*courses*') ? 'home-icon active' : '' }}">
                                <a href="{{url('/courses')}}" class="link-term mercado-item-title">Courses</a>
                            </li>
                            <li class="menu-item {{ request()->is('*cart*') ? 'home-icon active' : '' }}">
                            ...
                            <li class="menu-item {{ request()->is('*contact-us*') ? 'home-icon active' : '' }}">
