...
<head>
  ...
  <!-- endinject -->
  {{-- <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/images/Logo-04.png')}}"> --}}
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        {{-- <img src="{{asset('assets/images/Logo-04.png')}}" class="mr-2" alt="logo"/> --}}
        <a class="navbar-brand brand-logo mr-5" href="{{route('admin.dashboard')}}">
             <img src="{{asset('assets/images/logo.png')}}" alt="mercado">
        </a>
        {{-- <img src="{{asset('assets/images/Logo-04.png')}}" alt="logo"/> --}}
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item {{ request()->is('*admin/course-videos*') ? 'active' : '' }}">
            <a class="nav-link" href="{{route('admin.coursevideos')}}">
              <i class="fa-solid fa-computer icon-grid menu-icon"></i>
              <span class="menu-title">Manage Course Videos</span>
            </a>
          </li>
          ...
          <li class="nav-item {{ request()->is('*admin/attributes*') ? 'active' : '' }}">
            <a class="nav-link" href="{{route('admin.attributes')}}">
              ...
              <span class="menu-title">Manage Course Requirements</span>
            </a>
          </li>
          ...
          <li class="nav-item {{ request()->is('*admin/homeCategories*') ? 'active' : '' }}">
            <a class="nav-link" href="{{route('admin.homecategories')}}">
             <i class="icon-grid fa-solid fa-certificate icon-grid menu-icon"></i>
              <span class="menu-title">Manage Home Course Categories</span>
            </a>
          </li>
          ...
          <li class="nav-item {{ request()->is('*admin/sale*') ? 'active' : '' }}">
            <a class="nav-link" href="{{route('admin.sale')}}">
              ...
              <span class="menu-title">Manage OnSale Courses</span>
            </a>
          </li>
          ...
          <li class="nav-item {{ request()->is('*admin/orders*') ? 'active' : '' }}">
            <a class="nav-link" href="{{route('admin.orders')}}">
              ...
              <span class="menu-title">Ordered Courses</span>
            </a>
          </li>
        ...
        <div class="content-wrapper">
            ...
            <footer class="footer">
                <div class="d-sm-flex justify-content-center justify-content-sm-between">
                  <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © <?php echo date("Y");?>. <span class="text-primary">Sikdershop </span> All rights reserved.</span>
                </div>
            </footer>
        </div>
      </div>
...
$('.printMerchandiser').on('click', function () {
    $("#Merchandiser").print({
        append : null,
        globalStyles: true,
        mediaPrint: false,
