    ...
    <div class="container">
        ...
        <div class="wrap-breadcrumb">
            <ul>
                ...
                <li class="item-link"><span>Courses</span></li>
            </ul>
        </div>
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                ...
                <div class="wrap-shop-control">
                    ...
                    <h1 class="shop-title">All Courses</h1>
                            ...
                            <div class="product product-style-3 equal-elem ">
                                ...
                                <div class="product-info">
                                    ...
                                    <div id="course-rating-students">
                                        ...
                                        {{-- </div> --}}
                                        <div>
                                            <h6 class="fc-name">{{$product->students}} students</h6>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div id="course_description-wrap">
                                                <h6 id="course_description-head">{!!$product->short_description!!}<a href="{{route('product.details',['slug'=>$product->slug])}}" class="product-name text-danger"><b>..Show Details</b></a></h6>
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            @if($product->sale_price)
                                                <div class="wrap-price"><del><p class="product-price"><b> <span> &#2547;</span>{{$product->regular_price}}</b></p></del>   <ins><p class="product-price text-dark" style="margin-left: 20px;"><b><span class="">&#2547;</span>{{$product->sale_price}}</b></p></ins></div>
                                            @else
            ...
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
                ...
                {{-- <div class="widget mercado-widget filter-widget price-filter">
                    <h2 class="widget-title">Price <span class="text-info"><span class="text-danger">&#2547;</span>{{$min_price}} - <span class="text-danger">&#2547;</span>{{$max_price}}</span></h2>
