            ...
            <div class="col-md-8">
                <div class="card p-3">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <p class="card-title">Edit Video To Course</p>
                            </div>
                            <div class="col-md-6">
                        ...
                        @endif
                        <form wire:submit.prevent="updateCourseVideo" class="forms-sample" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control input-file" wire:model="newvideo">
                                @if ($newvideo)
                                ...
                                @else
                                    <video width="320" height="240" controls>
                                        <source src="{{asset('assets/images/Course_Videos')}}/{{$video}}" type="video/mp4">
                                    </video>
                                @endif
                                @error('newvideo')<span class="text-danger">{{$message}}</span> @enderror <br>
                              </div>
