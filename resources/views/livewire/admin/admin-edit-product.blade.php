            ...
            <div class="col-md-8">
                <div class="card p-5">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <p class="card-title">Edit Course</p>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            <label>Instructor Image</label>
                              <input type="file" class="form-control input-file" wire:model="newinstructor_image">
                                @if ($newinstructor_image)
                                    <img src="{{ $newinstructor_image->temporaryUrl() }}" width="120">
                                @else
                                    <img src="{{asset('assets/images/instructors')}}/{{$instructor_image}}" width="120">
                                @endif
                                @error('newinstructor_image')<span class="text-danger">{{$message}}</span> @enderror <br>
                          </div>
