    ...
    <div class=" main-content-area">
        ...
        <div class="wrap-iten-in-cart">
            ...
            <ul class="products-cart">
                ...
                <li class="pr-cart-item">
                    ...
                    <div class="price-field produtc-price"><p class="price"><del><span class="text-danger">&#2547;</span>{{$item->model->regular_price}}</del></p></div>
                    <div class="price-field produtc-price"><p class="price"><span class="text-danger">&#2547;</span>{{$item->model->sale_price}}</p></div>
                    <div class="quantity">
        ...
        <div class="summary">
            <div class="order-summary">
                ...
                @else
                    {{-- <p class="summary-info"><span class="title">Tax</span><b class="index"><span class="text-danger">&#2547;</span>{{Cart::instance('cart')->tax()}}</b></p> --}}
                    <p class="summary-info total-info "><span class="title">Total</span><b class="index"><span class="text-danger">&#2547;</span>{{Cart::instance('cart')->total()}}</b></p>
                @endif
            </div>
            <div class="checkout-info">
                ...
                <a class="btn btn-checkout" href="#" wire:click.prevent="checkout">Pay Now</a>
                    {{-- <hr class="mb-4"> --}}
                <a class="link-to-shop" href="{{url('/shop')}}">Continue Coursing<i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>

            </div>

            <div class="update-clear">
                <a class="btn btn-clear" href="#" wire:click.prevent="destroyAll()">Clear Cart</a>
                <a class="btn btn-update" href="/shop">Update Cart</a>
            </div>
        </div>
        @else
          <div class="text-center" style="padding:30px 0px">
            <h1>Your cart is empty!</h1>
             <p>Add Course to it now</p>
             <a href="/courses" class="btn btn-success">Search Courses</a>
        </div>
        @endif
        ...
        <div class="wrap-show-advance-info-box style-1 box-in-site">
            <h3 class="title-box">Most Viewed Courses</h3>
