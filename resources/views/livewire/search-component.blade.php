                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <h6 id="course_description">{!!$product->short_description!!}<a href="{{route('product.details',['slug'=>$product->slug])}}" class="product-name text-danger"><b>..Show Details</b></a></h6>
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
