                                    ...
                                    <div class="item-content">
                                        <div class="wrap-vertical-nav">
                                            <ul>
                                                ...
                                                <li class="menu-item"><a href="#" class="link-term">Special courses</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="coppy-right-box">
                <div class="container">
                    <div class="coppy-right-item item-left">
                        <p class="coppy-right-text">Copyright © <?php echo date("Y");?> Kaizen Institute. All rights reserved</p>
                    </div>
